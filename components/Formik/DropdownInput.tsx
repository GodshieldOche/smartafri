  ...
  return (
    ...
    >
      ...
      <div className=" w-full h-full relative">
        <div
          className={`w-full flex items-center py-[15px] px-4 space-x-3  md:px-[18px] border rounded-[5px] outline-none text-grayOne
         ${
        ...
        <div className="absolute h-full top-0 bottom-0 my-auto right-3 flex flex-col justify-center">
          {active ? (
            <Icon
              ...
              className="!text-primaryOne !font-medium !text-base"
            />
          ) : (
            <Icon
